                    ...
                    <section class="panel panel-default">
                        ...
                        <div class="table-responsive">
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <a class="button" href="AddStaff.aspx">Add New Staff Member</a>
                                    </div>
                                    <div class="col-sm-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <p><strong>Member Type: </strong>
                                    <asp:Literal ID="LitType" runat="server"></asp:Literal></p>
                                <p><strong>Date of Birth: </strong>
                                    <asp:Literal ID="LitDOB" runat="server"></asp:Literal></p>
                                <p><strong>Address: </strong>
                                    <asp:Literal ID="LitAddress" runat="server"></asp:Literal></p>
                                <p><strong>Contact No: </strong>
                                    <asp:Literal ID="LitContactNo" runat="server"></asp:Literal></p>
                                <p><strong>Date of joining: </strong>
                                    <asp:Literal ID="LitDOJ" runat="server"></asp:Literal></p>
